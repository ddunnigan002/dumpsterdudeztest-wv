...
import { ArrowLeft, Truck, Bell, Settings, Building2, Database, Plus } from "lucide-react"
        ...
        <TabsContent value="maintenance" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set intervals and customize maintenance checklists</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Checklist Intervals */}
                <Card className="border-orange-200">
                  <CardHeader>
                    <CardTitle className="text-lg">Checklist Intervals</CardTitle>
                    <CardDescription>Configure how often checklists are required</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="daily-required">Daily Checklist Required</Label>
                      <input type="checkbox" id="daily-required" className="rounded" defaultChecked />
                    </div>
                    <div>
                      <Label htmlFor="weekly-interval">Weekly Checklist Interval (days)</Label>
                      <Input type="number" id="weekly-interval" defaultValue="7" min="1" max="14" />
                    </div>
                    <div>
                      <Label htmlFor="monthly-interval">Monthly Checklist Interval (days)</Label>
                      <Input type="number" id="monthly-interval" defaultValue="30" min="15" max="60" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-orange-200">
                  <CardHeader>
                    <CardTitle className="text-lg">Mileage-Based Maintenance</CardTitle>
                    <CardDescription>Set mileage intervals for major services</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <Label htmlFor="oil-change-miles">Oil Change Interval (miles)</Label>
                      <Input type="number" id="oil-change-miles" defaultValue="5000" />
                    </div>
                    <div>
                      <Label htmlFor="tire-rotation-miles">Tire Rotation Interval (miles)</Label>
                      <Input type="number" id="tire-rotation-miles" defaultValue="7500" />
                    </div>
                    <div>
                      <Label htmlFor="brake-inspection-miles">Brake Inspection Interval (miles)</Label>
                      <Input type="number" id="brake-inspection-miles" defaultValue="15000" />
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="flex justify-end">
                <Button className="bg-orange-500 hover:bg-orange-600">Save Maintenance Settings</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
